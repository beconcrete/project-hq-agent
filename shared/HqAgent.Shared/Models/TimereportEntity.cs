...
// PartitionKey = employeeEmail (lowercase), RowKey = {date:yyyyMMdd}_{projectId}_{ticks:D20}
...
{
    public string PartitionKey { get; set; } = string.Empty; // employeeEmail (lowercase)
